...
class Config:
    def __init__(self):
        ...
        self.model_dir = "models/image_captioning_gru"

    def define_model(self):
        """Định nghĩa kiến trúc mô hình với GRU"""
        ...
        # 2. Sequence Model (input 2) - Sử dụng GRU
        ...
        se3 = GRU(self.config.units, return_sequences=True)(se2)
        se4 = GRU(self.config.units)(se3)
